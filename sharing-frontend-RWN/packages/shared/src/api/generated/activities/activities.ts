...
export const postApiActivitiesTripTripId = (
    tripId: number,
    postApiActivitiesTripTripIdBody: PostApiActivitiesTripTripIdBody, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<Activity>> => {
    
    
    return axios.post(
      `/api/activities/trip/${tripId}`,
      postApiActivitiesTripTripIdBody,options
    );
  }
...
export const getPostApiActivitiesTripTripIdMutationOptions = <TError = AxiosError<Error>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiActivitiesTripTripId>>, TError,{tripId: number;data: PostApiActivitiesTripTripIdBody}, TContext>, axios?: AxiosRequestConfig}
