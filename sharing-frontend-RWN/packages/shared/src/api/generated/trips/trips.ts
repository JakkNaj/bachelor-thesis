...
export const postApiTrips = (
    postApiTripsBody: PostApiTripsBody, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<Trip>> => {
    
    
    return axios.post(
      `/api/trips`,
      postApiTripsBody,options
    );
  }
...
export const getPostApiTripsMutationOptions = <TError = AxiosError<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiTrips>>, TError,{data: PostApiTripsBody}, TContext>, axios?: AxiosRequestConfig}
