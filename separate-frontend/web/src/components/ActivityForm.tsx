		...
		<form onSubmit={handleSubmit(onSubmitForm)} className="space-y-6">
			...
			<div className="space-y-4">
				<div>
					...
					<Input id="title" type="text" {...register("title")} error={errors.title?.message} />
				</div>
				...
				<div>
					...
					<SelectInputNative id="type" {...register("type")} error={errors.type?.message}>
						<option value="">Select a type</option>
						{Object.values(ActivityInputType).map((type) => (
