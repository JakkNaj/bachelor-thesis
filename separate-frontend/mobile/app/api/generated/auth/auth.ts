...
import type { AuthResponse, Error, PostApiAuthLoginBody, PostApiAuthSignupBody } from ".././schemas";
 ...
 */
export const postApiAuthLogin = (postApiAuthLoginBody: PostApiAuthLoginBody, signal?: AbortSignal) => {
...
export const getPostApiAuthLoginMutationOptions = <TError = Error, TContext = unknown>(options?: {
	mutation?: UseMutationOptions<Awaited<ReturnType<typeof postApiAuthLogin>>, TError, { data: PostApiAuthLoginBody }, TContext>;
 ...
 * @summary Login a user
 */
export const usePostApiAuthLogin = <TError = Error, TContext = unknown>(options?: {
	mutation?: UseMutationOptions<Awaited<ReturnType<typeof postApiAuthLogin>>, TError, { data: PostApiAuthLoginBody }, TContext>;
}): UseMutationResult<Awaited<ReturnType<typeof postApiAuthLogin>>, TError, { data: PostApiAuthLoginBody }, TContext> => {
 ...
 */
export const postApiAuthSignup = (postApiAuthSignupBody: PostApiAuthSignupBody, signal?: AbortSignal) => {
	return customInstance<AuthResponse>({
		url: `/api/auth/signup`,
		method: "POST",
		headers: { "Content-Type": "application/json" },
...
export const getPostApiAuthSignupMutationOptions = <TError = Error, TContext = unknown>(options?: {
	mutation?: UseMutationOptions<Awaited<ReturnType<typeof postApiAuthSignup>>, TError, { data: PostApiAuthSignupBody }, TContext>;
 ...
 * @summary Register a new user
 */
export const usePostApiAuthSignup = <TError = Error, TContext = unknown>(options?: {
	mutation?: UseMutationOptions<Awaited<ReturnType<typeof postApiAuthSignup>>, TError, { data: PostApiAuthSignupBody }, TContext>;
}): UseMutationResult<Awaited<ReturnType<typeof postApiAuthSignup>>, TError, { data: PostApiAuthSignupBody }, TContext> => {
...
export const postApiAuthLogout = (signal?: AbortSignal) => {
	return customInstance<Error>({ url: `/api/auth/logout`, method: "POST", signal });
};

export const getPostApiAuthLogoutMutationOptions = <TError = Error, TContext = unknown>(options?: {
 ...
 * @summary Logout a user
 */
export const usePostApiAuthLogout = <TError = Error, TContext = unknown>(options?: {
	mutation?: UseMutationOptions<Awaited<ReturnType<typeof postApiAuthLogout>>, TError, void, TContext>;
